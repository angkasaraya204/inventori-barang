   ...
   <div class="w-64 bg-gray-900 h-full p-4 fixed top-0 left-0">
     <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
      ...
      <ul class="mt-4">
        ...
        <li class="mb-1 group">
         <a href="/stockop" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-600 rounded-lg">
            <i class="ri-folder-reduce-fill mr-3 text-lg"></i>
        ...
        <li class="mb-1 group">
         <a href="/detstockop" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-600 rounded-lg">
            <i class="ri-folder-reduce-fill mr-3 text-lg"></i>
            <span class="text-sm">Detail Stock Opname</span>
         </a>
        </li>
