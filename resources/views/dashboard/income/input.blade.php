...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ '/barang/masuk/input/' }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="@error('quantity')  border-red-400  @enderror">
                                        ...
                                        placeholder="Masukkan Jumlah Barang Masuk" name="quantity" value="{{old('quantity')}}">
                                    </div>
                                </div>
                                @error('quantity')
                                    <p class="italic text-red-500 text-sm mt-1">{{$message}}</p>
