...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/ubah-barang/{{$product->id}}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('name') border-red-400 @enderror">
                                        ...
                                        placeholder="Masukkan Nama Barang" name="name" value="{{$product->name}}">
                                    </div>
                                </div>
                                @error('name')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('price') border-red-400 @enderror">
                                        ...
                                        placeholder="Masukkan Harga" name="price" value="{{$product->price}}">
                                    </div>
                                </div>
                                @error('price')
                                    <p class="italic text-red-500 text-sm mt-1">{{$message}}</p>
