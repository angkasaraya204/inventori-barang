...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ '/role/input/' }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('email')  border-red-400  @enderror">
                                        ...
                                        placeholder="Masukkan Email Kategori" name="email" value="{{old('email')}}">
                                    </div>
                                </div>
                                @error('email')
                                    <p class="italic text-red-500 text-sm mt-1">{{$message}}</p>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="@error('role')  border-red-400  @enderror form-control" id="role" name="role">
                                        ...
                                        <option value="kepalagudang" {{ old('role') == 'kepalagudang' ? 'selected' : '' }}>Kepala Gudang</option>
                                        <option value="officer" {{ old('role') == 'officer' ? 'selected' : '' }}>Petugas</option>
                                    </select>
                                </div>
                                @error('role')
                                    <p class="italic text-red-500 text-sm mt-1">{{$message}}</p>
