...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ '/barang/keluar/input' }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('product_id')  border-red-400  @enderror">
                                        <select name="product_id" class="select-product form-select" id="product_id">
                                        </select>
                                    </div>
                                </div>
                                @error('product_id')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('supplier_id')  border-red-400  @enderror">
                                        <select name="supplier_id" class="select-supplier form-select" id="supplier_id">
                                        </select>
                                    </div>
                                </div>
                                @error('supplier_id')
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="@error('quantity')  border-red-400  @enderror">
                                        ...
                                        placeholder="Masukkan Jumlah Barang Keluar" name="quantity" value="{{old('quantity')}}">
                                    </div>
                                </div>
                                @error('quantity')
                                    <p class="italic text-red-500 text-sm mt-1">{{$message}}</p>
